...
This library consists wrapper Vue.js components over [fai-dnd](http://gitlab.faidev.cc/frontend/fai-dnd) library.

## Demo

View the demo here:

- http://dnd-vue.docs.aaa.cn

## Installation

```shell
npm i @fk/fai-dnd-vue
```
